...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
			...
			{
				echo '
				<tr id="board_', $board['id'], '" class="boardbg">
					<td class="icon"', !empty($board['children']) ? ' rowspan="1"' : '', '>
						<a href="', ($board['is_redirect'] || $context['user']['is_guest'] ? $board['href'] : $scripturl . '?action=unread;board=' . $board['id'] . '.0;children'), '">';

				// If the board or children is new, show an indicator.
				if ($board['new'] || $board['children_new'])
					echo '
							<img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'on', $board['new'] ? '' : '', '.png" alt="', $txt['new_posts'], '" title="', $txt['new_posts'], '" />';
				// Is it a redirection board?
				elseif ($board['is_redirect'])
					echo '
							<img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'on2.png" alt="*" title="*" />';
	...
	<div id="posting_icons" class="floatleft">';
		...
		<ul class="reset">
			...
			<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'on2.png" alt="" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
	...
	<div id="posting_icons" class="flow_hidden">
		<ul class="reset">
			<li class="floatleft"><img src="', $settings['images_url'], '/on.png" alt="" /> ', $txt['old_posts'], '</li>
			<li class="floatleft"><img src="', $settings['images_url'], '/on2.png" alt="" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
	}
